...
int main(int argc, char *argv[])
{
  try {
    ...
    desc.add_options()(
      "help,h", "Help screen")(
      "verbose,v", "verbose")(
      "mode,m", po::value<std::string>(), "client or server mode")(
      "server-addr,a", po::value<std::string>()->default_value("192.168.12.2"), "Server's IPoIB addr")(
      "port,p", po::value<std::string>()->default_value("12345"), "server port")(
      "indexfile,i", po::value<std::string>(), "path to .idx file")(
      "edgefile,e", po::value<std::string>(), "path to .adj file")(
      "kernel,k", po::value<std::string>()->default_value("print_graph"), "kernel to run")(
      "ofile,o", po::value<std::string>()->default_value("/home/username/graphs/kernel-out.txt"), "path to output file")(
      "threads,t", po::value<unsigned long>()->default_value(0), "Number of Worker threads. 0 for all available cores")(
